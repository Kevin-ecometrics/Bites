  ...
  return (
    <main>
      <div className="flex justify-center flex-col items-center mt-8 px-8 pb-16">
        ...
        <h3 className="text-pink-600 font-poorstory text-4xl font-normal">
          Select a date and time to save your dental care day
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-2 mt-32 gap-16">
          <div>
          ...
          <div>
            ...
            <div className="flex gap-4 mt-2">
              ...
              <input
                ...
                className="w-72 bg-[#D9D9D9] text-black border border-black rounded-lg px-4 "
              />
            </div>
            ...
            <button className="bg-pink-600 text-white mt-8 rounded-3xl py-2 px-8 text-xl font-bold font-poppins hover:bg-pink-800">BOOK US NOW</button>
          </div>
        </div>
      </div>
    </main>
